  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Gestão de diretores</li>
          </ol>
          <div class="container">
      <div class="card card-register mx-auto mt-5">
        ...
        <div class="card-body">
          <form>
                <a class="btn btn-primary btn-block" href="addDiretor.php">Cadastrar diretor</a>
                <br>
                <a class="btn btn-primary btn-block" href="alteraDiretor.php">Alterar diretor</a>
                <br>
                <a class="btn btn-primary btn-block" href="removeDiretor.php">Remover diretor</a>
          </form>
        </div>
      </div>
    </div>
