  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div class="card card-register mx-auto mt-5">
        ...
        <div class="card-body">
          <form>
                <a class="btn btn-primary btn-block" href="addCurso.php">Cadatrar curso</a>
                <br>
                <a class="btn btn-primary btn-block" href="alteraCurso.php">Alterar curso</a>
                <br>
                <a class="btn btn-primary btn-block" href="removeCurso.php">Remover curso</a>
          </form>
        </div>
      </div>
    </div>
