  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Gestão de mensalidades</li>
          </ol>
          <div class="container">
      <div class="card card-register mx-auto mt-5">
        ...
        <div class="card-body">
          <form>
                <a class="btn btn-primary btn-block" href="addMensalidade.php">Cadastrar mensalidade</a>
                <br>
                <a class="btn btn-primary btn-block" href="alteraMensalidade.php">Alterar mensalidade</a>
                <br>
                <a class="btn btn-primary btn-block" href="removeMensalidade.php">Remover mensalidade</a>
          </form>
        </div>
      </div>
    </div>
