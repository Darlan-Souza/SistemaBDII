  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Gestão de matriculas</li>
          </ol>
          <div class="container">
      <div class="card card-register mx-auto mt-5">
        ...
        <div class="card-body">
          <form>
                <a class="btn btn-primary btn-block" href="addMatricula.php">Cadastrar matricula</a>
                <br>
                <a class="btn btn-primary btn-block" href="alteraMatricula.php">Alterar matricula</a>
                <br>
                <a class="btn btn-primary btn-block" href="removeMatricula.php">Remover matricula</a>
          </form>
        </div>
      </div> 
    </div>
