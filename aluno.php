  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Gestão de alunos</li>
          </ol>
          <div class="container">
      <div class="card card-register mx-auto mt-5">
        ...
        <div class="card-body">
          <form>
                <a class="btn btn-primary btn-block" href="addAluno.php">Cadastrar aluno</a>
                <br>
                <a class="btn btn-primary btn-block" href="alteraAluno.php">Alterar aluno</a>
                <br>
                <a class="btn btn-primary btn-block" href="removeAluno.php">Remover aluno</a>
          </form>
        </div>
      </div>
    </div>
