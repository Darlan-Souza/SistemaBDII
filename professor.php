  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Gestão de professores</li>
          </ol>
          <div class="container">
      <div class="card card-register mx-auto mt-5">
        ...
        <div class="card-body">
          <form>
                <a class="btn btn-primary btn-block" href="cadastraAluno.php">Cadastrar professor</a>
                <br>
                <a class="btn btn-primary btn-block" href="alteraAluno.php">Alterar professor</a>
                <br>
                <a class="btn btn-primary btn-block" href="excluiAluno.php">Remover professor</a>
          </form>
        </div>
      </div>
    </div>
